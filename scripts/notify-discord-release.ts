  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new SPEG prerelease is available for nightly testers."
          : "A new SPEG latest release is available.",
...
).pipe(Command.withDescription("Post a SPEG release announcement to Discord."));
