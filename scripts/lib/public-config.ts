...
export interface SpegPublicConfig {
...
export function loadRepoEnv({
  ...
  return {
    ...
    ...(config.clerkPublishableKey
      ? {
          SPEG_CLERK_PUBLISHABLE_KEY: config.clerkPublishableKey,
    ...
    ...(config.clerkJwtTemplate
      ? {
          SPEG_CLERK_JWT_TEMPLATE: config.clerkJwtTemplate,
...
export function resolvePublicConfig(...sources: readonly Environment[]): SpegPublicConfig {
  return {
