...
describe("parsePullRequestReference", () => {
  ...
  it("accepts Azure DevOps pull request URLs", () => {
    expect(
      parsePullRequestReference("https://dev.azure.com/acme/project/_git/speg/pullrequest/42"),
    ).toBe("https://dev.azure.com/acme/project/_git/speg/pullrequest/42");
  });
  ...
  it("accepts legacy Azure DevOps pull request URLs", () => {
    expect(
      parsePullRequestReference("https://acme.visualstudio.com/project/_git/speg/pullrequest/42"),
    ).toBe("https://acme.visualstudio.com/project/_git/speg/pullrequest/42");
  });
