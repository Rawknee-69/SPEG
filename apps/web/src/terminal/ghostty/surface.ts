...
export class GhosttyTerminalSurface {
  ...
  static async create(
    ...
    canvas.className = "speg-ghostty-canvas";
    canvas.style.cssText = "display:block;width:100%;height:100%;";
    canvas.setAttribute("aria-hidden", "true");

    const input = document.createElement("textarea");
    input.className = "speg-ghostty-input";
    ...
    scrollbar.className = "speg-ghostty-scrollbar";
    ...
    scrollbarThumb.className = "speg-ghostty-scrollbar-thumb";
