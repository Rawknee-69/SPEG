...
export const PERSISTED_STATE_KEY = "speg:ui-state:v1";
const THREAD_CHANGED_FILES_EXPANSION_VERSION = 1;
const LEGACY_PERSISTED_STATE_KEYS = [
  "speg:renderer-state:v8",
  "speg:renderer-state:v7",
  "speg:renderer-state:v6",
  "speg:renderer-state:v5",
  "speg:renderer-state:v4",
  "speg:renderer-state:v3",
