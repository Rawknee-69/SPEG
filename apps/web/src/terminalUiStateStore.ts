...
import { parseScopedThreadKey, scopedThreadKey } from "@speg/client-runtime/environment";
import { type ScopedThreadRef } from "@speg/contracts";
...
const TERMINAL_UI_STATE_STORAGE_KEY = "speg:terminal-state:v1";
