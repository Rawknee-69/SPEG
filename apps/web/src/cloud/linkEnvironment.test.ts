...
import { RelayWebClientId } from "@speg/contracts/relay";
...
beforeEach(() => {
  vi.clearAllMocks();
  vi.stubEnv("VITE_SPEG_RELAY_URL", "https://relay.example.test");
