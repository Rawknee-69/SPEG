...
import { resolveAssetUrl } from "@speg/client-runtime/state/assets";
import type { AssetResource, EnvironmentId } from "@speg/contracts";
...
export { resolveAssetUrl } from "@speg/client-runtime/state/assets";
