import { CheckpointRef, EnvironmentId, MessageId, TurnId } from "@speg/contracts";
        ...
        timelineEntries={[
          {
            ...
            entry: {
              ...
              label: "Updated files",
              tone: "tool",
              changedFiles: ["C:/Users/mike/dev-stuff/speg/apps/web/src/session-logic.ts"],
            },
          },
        ]}
        workspaceRoot="C:/Users/mike/dev-stuff/speg"
      />,
    );

    expect(markup).toContain("speg/apps/web/src/session-logic.ts");
    expect(markup).not.toContain("C:/Users/mike/dev-stuff/speg/apps/web/src/session-logic.ts");
  });
