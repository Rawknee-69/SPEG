...
import { isWorkspaceImagePreviewPath } from "@speg/shared/filePreview";
...
const FILE_EXPLORER_STORAGE_KEY = "speg.fileExplorerOpen";
const RENDER_MARKDOWN_STORAGE_KEY = "speg.renderMarkdown";
