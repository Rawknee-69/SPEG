import type { ContextMenuItem, PreviewSessionSnapshot } from "@speg/contracts";
...
const SURFACE_DISABLED_REASONS = {
  browser: "Browser previews are only available in the SPEG desktop app.",
...
function RightPanelEmptyState(props: {
  ...
  const actions = [
    ...
    {
      label: "CACM",
      description: "Cross-agent context timeline.",
      icon: Network,
      available: true,
      disabledReason: null,
      onClick: props.onAddCacm,
    },
  ] as const;
...
export function RightPanelTabs(props: RightPanelTabsProps) {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "glass-surface glass-thin glass-panel-tabbar workspace-topbar gap-1 pl-2",
