...
import { encodeConnectAuthCode, readConnectAuthorizeRequest } from "@speg/shared/connectAuth";
...
const invalidLinkMessage = {
  ...
  description:
    "The link is missing its authorization request. Re-run `speg connect` in your terminal and open the freshly printed URL.",
} as const;
  ...
  return (
    <AuthSurfaceShell>
      <ConnectCliAuthMessage
        ...
        description={
          isSignedIn
            ? "Redirecting to authorize SPEG Connect for your CLI…"
            : "Sign in to continue authorizing SPEG Connect for your CLI."
        }
      />
      {isLoaded && !isSignedIn ? (
        <div className="mt-6">
    ...
    return (
      <AuthSurfaceShell>
        <ConnectCliAuthMessage
          ...
          description="No authorization code was returned. Re-run `speg connect` in your terminal and try again."
        />
      </AuthSurfaceShell>
    );
  }
    ...
    return (
      <AuthSurfaceShell>
        <ConnectCliAuthMessage
          ...
          description="This authorization response does not match a connect request started in this browser. Re-run `speg connect` in your terminal and open the freshly printed URL in this browser."
        />
      </AuthSurfaceShell>
    );
  }
  ...
  return (
    <AuthSurfaceShell>
      ...
      <p className="mt-6 text-xs leading-relaxed text-muted-foreground">
        ...
        their machine to your SPEG Connect account while it is valid.
      </p>
    </AuthSurfaceShell>
  );
}
