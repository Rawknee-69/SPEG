import type { RelayClientDeviceRecord } from "@speg/contracts/relay";
  ...
  return (
    <Empty className="min-h-72 rounded-xl border border-dashed bg-muted/15">
      ...
      <EmptyHeader>
        ...
        <EmptyDescription>
          Sign in to SPEG on your iPhone to register it for push notifications and Live
          Activities.
        </EmptyDescription>
      </EmptyHeader>
    </Empty>
      ...
      <header className="flex flex-col gap-4 border-b px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Devices registered to receive SPEG Connect activity from your environments.
          </p>
        </div>
        <Button
          size="sm"
