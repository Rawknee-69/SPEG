...
const PIERRE_ICON_SPRITE_ID = "speg-pierre-file-icon-sprite";

const SPEG_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="speg-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="speg-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="speg-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="speg-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="speg-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="speg-file-icon-pnpm" viewBox="0 0 32 32">
...
export const SPEG_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: SPEG_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "speg-file-icon-package-json",
    "tsconfig.json": "speg-file-icon-tsconfig",
    "agents.md": "speg-file-icon-agents",
    "claude.md": "speg-file-icon-claude",
    "readme.md": "speg-file-icon-readme",
    "pnpm-lock.yaml": "speg-file-icon-pnpm",
    "pnpm-workspace.yaml": "speg-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(SPEG_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${SPEG_FILE_ICON_SPRITE}`;
