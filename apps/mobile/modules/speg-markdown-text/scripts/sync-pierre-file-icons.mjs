...
const customSprite = webIconSource.match(/const SPEG_FILE_ICON_SPRITE = `([\s\S]*?)`;/)?.[1];

if (!customSprite) {
  throw new Error("Could not read the SPEG Pierre icon sprite from apps/web/src/pierre-icons.ts");
}
...
const customIcons = {
  agents: "speg-file-icon-agents",
  claude: "speg-file-icon-claude",
  package: "speg-file-icon-package-json",
  pnpm: "speg-file-icon-pnpm",
  readme: "speg-file-icon-readme",
  tsconfig: "speg-file-icon-tsconfig",
};
