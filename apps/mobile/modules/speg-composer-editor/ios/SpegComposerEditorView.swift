...
private final class ComposerTextView: UITextView {
  private static let pastedImageDirectoryName = "speg-composer-paste"
...
public final class SpegComposerEditorView: ExpoView, UITextViewDelegate, UITextDropDelegate {
