...
Pod::Spec.new do |s|
  s.name = 'SpegTerminalNative'
  s.version = package['version']
  s.summary = 'Native terminal surface for SPEG mobile.'
  s.description = 'Native terminal surface bridge used by the SPEG React Native app.'
