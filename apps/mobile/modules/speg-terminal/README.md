# SPEG Mobile Terminal Native Module
...
fork, with SPEG's iOS 16 compatibility patch applied. `SpegTerminalView` owns a `libghostty` surface and
...
```bash
apps/mobile/modules/speg-terminal/scripts/build-libghostty-ios16.sh
```
...
```bash
apps/mobile/modules/speg-terminal/scripts/build-libghostty-android.sh
```
