...
const CONNECTIONS_KEY = "speg.connections";
const AGENT_AWARENESS_DEVICE_ID_KEY = "speg.agent-awareness.device-id";
const AGENT_AWARENESS_REGISTRATION_KEY = "speg.agent-awareness.registration";
const RECENT_THREAD_SHORTCUTS_KEY = "speg.recent-thread-shortcuts";
...
>()("@speg/mobile/persistence/MobileStorage") {}
