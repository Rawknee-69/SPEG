import type { EnvironmentRpcSubscriptionObservation } from "@speg/client-runtime/rpc";
import { type BackgroundScope, type EnvironmentId, WS_METHODS } from "@speg/contracts";
