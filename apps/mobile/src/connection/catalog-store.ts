...
import { ConnectionTransientError } from "@speg/client-runtime/connection";
...
export const CONNECTION_CATALOG_KEY = "speg.connection-catalog.v1";
export const LEGACY_CONNECTIONS_KEY = "speg.connections";
