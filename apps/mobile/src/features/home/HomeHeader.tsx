import type { EnvironmentId, SidebarThreadSortOrder } from "@speg/contracts";
...
import { SpegWordmark } from "../../components/SpegWordmark";
        ...
        <View className="w-full max-w-[720px] self-center gap-3">
          <View className="flex-row items-center gap-2.5">
            <View className="flex-1 flex-row items-center gap-2">
              {/* Mirrors the desktop SidebarBrand: SPEG mark + muted "Code". */}
              <SpegWordmark color={iconColor} height={15} />
              <RNText className="-ml-0.5 text-[21px] font-speg-medium tracking-[-0.5px] text-foreground-muted">
                Code
              </RNText>
              <View className="rounded-full bg-subtle px-2 py-0.75">
                <RNText className="text-[11px] font-speg-bold tracking-[1.1px] text-foreground-muted uppercase">
                  {stageLabel}
                </RNText>
              </View>
            </View>
