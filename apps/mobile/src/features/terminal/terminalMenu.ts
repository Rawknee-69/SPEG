import { type KnownTerminalSession } from "@speg/client-runtime/state/terminal";
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@speg/contracts";
...
} from "@speg/shared/terminalLabels";
