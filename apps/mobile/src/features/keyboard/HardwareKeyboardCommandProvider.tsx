...
import { SpegKeyboardCommands } from "../../native/SpegKeyboardCommands";
import {
...
export function HardwareKeyboardCommandProvider({
  ...
  return (
    <SpegKeyboardCommands enabledCommands={enabledCommands} onCommand={onCommand}>
      {children}
    </SpegKeyboardCommands>
  );
}
