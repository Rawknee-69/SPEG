...
export function ThreadWorkLog(props: {
  ...
  return (
    <View className="-mx-1 mb-1 px-1 py-0">
      {!onlyToolRows ? (
        <Text className="px-0.5 pb-0.5 font-speg-medium text-2xs text-foreground-muted opacity-60">
          work log
        </Text>
      ) : null}
              ...
              >
                <View className="min-h-8 flex-row items-center gap-1.5">
                  ...
                  <Text className="min-w-0 flex-1 text-xs text-foreground" numberOfLines={1}>
                    <Text
                      className={cn(
                        "font-speg-medium text-foreground",
                  ...
                  <View className="shrink-0 flex-row items-center gap-px">
                    {props.copiedRowId === row.id ? (
                      <Text className="pr-1 font-speg-medium text-3xs text-emerald-600 dark:text-emerald-400">
                        Copied
                      </Text>
                    ) : null}
  ...
  return (
    <View className="-mx-1 mb-1 px-1 py-0">
      ...
      >
        ...
        <Text className="font-speg-medium text-xs text-foreground opacity-80">
