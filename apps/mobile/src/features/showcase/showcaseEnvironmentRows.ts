...
const SHOWCASE_LOCAL_ENVIRONMENT_DISPLAY_URLS: Readonly<Record<string, string>> = {
  ...
  "Suspense Station": "https://suspense-vps.hel1.speg.sh/",
...
const pocketPiEndpoint = {
  httpBaseUrl: "https://pocket-pi.speg.sh",
  wsBaseUrl: "wss://pocket-pi.speg.sh",
  providerKind: "speg_relay" as const,
};
...
export const SHOWCASE_CONNECTED_CLOUD_ENVIRONMENTS: ReadonlyArray<ConnectedEnvironmentSummary> = [
  {
    ...
    displayUrl: "https://aurora-gpu.speg.sh",
    isRelayManaged: true,
