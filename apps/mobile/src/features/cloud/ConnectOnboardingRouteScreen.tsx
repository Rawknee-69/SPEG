...
import { reportAtomCommandResult, settlePromise } from "@speg/client-runtime/state/runtime";
...
/**
 * Post-sign-in onboarding sheet for SPEG Connect. Mobile never publishes
 * environments itself — it consumes ones published elsewhere — so this simply
 * surfaces the account's SPEG Connect environments right after sign-in so every
        ...
        {isSignedIn ? (
          ...
          <View collapsable={false} className="rounded-[24px] bg-card p-5">
            <Text className="text-sm leading-normal text-foreground-muted">
              Sign in to your SPEG account to set up SPEG Connect.
            </Text>
          </View>
        )}
