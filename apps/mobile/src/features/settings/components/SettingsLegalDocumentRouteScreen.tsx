    ...
    return (
      <View className="flex-1 items-center justify-center gap-4 bg-sheet px-8">
        ...
        <View className="items-center gap-2">
          <Text className="text-center font-speg-bold text-lg text-foreground">
        ...
        <View className="w-full max-w-[320px] gap-2">
          ...
          >
            <Text className="font-speg-bold text-base text-sheet">Try Again</Text>
          </Pressable>
          <Pressable
          ...
          >
            <Text className="font-speg-medium text-base text-foreground-muted">Open in Browser</Text>
          </Pressable>
        </View>
      </View>
    );
