...
const requestLogPath = process.env.SPEG_ACP_REQUEST_LOG_PATH;
const exitLogPath = process.env.SPEG_ACP_EXIT_LOG_PATH;
const emitToolCalls = process.env.SPEG_ACP_EMIT_TOOL_CALLS === "1";
const emitInterleavedAssistantToolCalls =
  process.env.SPEG_ACP_EMIT_INTERLEAVED_ASSISTANT_TOOL_CALLS === "1";
const emitGenericToolPlaceholders = process.env.SPEG_ACP_EMIT_GENERIC_TOOL_PLACEHOLDERS === "1";
const emitAskQuestion = process.env.SPEG_ACP_EMIT_ASK_QUESTION === "1";
const emitXAiAskUserQuestion = process.env.SPEG_ACP_EMIT_XAI_ASK_USER_QUESTION === "1";
const emitXAiPromptCompleteThenHang = process.env.SPEG_ACP_EMIT_XAI_PROMPT_COMPLETE_THEN_HANG === "1";
const emitForeignSessionUpdates = process.env.SPEG_ACP_EMIT_FOREIGN_SESSION_UPDATES === "1";
const hangPromptForever = process.env.SPEG_ACP_HANG_PROMPT_FOREVER === "1";
const hangFirstPromptForever = process.env.SPEG_ACP_HANG_FIRST_PROMPT_FOREVER === "1";
const emitLateUpdateAfterCancel = process.env.SPEG_ACP_EMIT_LATE_UPDATE_AFTER_CANCEL === "1";
const omitXAiPromptCompleteStopReason =
  process.env.SPEG_ACP_OMIT_XAI_PROMPT_COMPLETE_STOP_REASON === "1";
const failLoadSession = process.env.SPEG_ACP_FAIL_LOAD_SESSION === "1";
const emitLoadReplay = process.env.SPEG_ACP_EMIT_LOAD_REPLAY === "1";
const hangLoadSessionAfterReplay = process.env.SPEG_ACP_HANG_LOAD_SESSION_AFTER_REPLAY === "1";
const delayLoadSessionAfterReplay = process.env.SPEG_ACP_DELAY_LOAD_SESSION_AFTER_REPLAY === "1";
const loadSessionDelayMs = Number(process.env.SPEG_ACP_LOAD_SESSION_DELAY_MS ?? "5000");
const emitStaleXAiPromptCompleteBeforeSecondHang =
  process.env.SPEG_ACP_EMIT_STALE_XAI_PROMPT_COMPLETE_BEFORE_SECOND_HANG === "1";
const emitOverlappingXAiPromptCompleteOutOfOrder =
  process.env.SPEG_ACP_EMIT_OVERLAPPING_XAI_PROMPT_COMPLETE_OUT_OF_ORDER === "1";
const failPrompt = process.env.SPEG_ACP_FAIL_PROMPT === "1";
const failSetConfigOption = process.env.SPEG_ACP_FAIL_SET_CONFIG_OPTION === "1";
const exitOnSetConfigOption = process.env.SPEG_ACP_EXIT_ON_SET_CONFIG_OPTION === "1";
const promptResponseText = process.env.SPEG_ACP_PROMPT_RESPONSE_TEXT;
const promptDelayMs = Number(process.env.SPEG_ACP_PROMPT_DELAY_MS ?? "0");
const permissionOptionIds = {
  allowOnce: process.env.SPEG_ACP_ALLOW_ONCE_OPTION_ID ?? "allow-once",
  allowAlways: process.env.SPEG_ACP_ALLOW_ALWAYS_OPTION_ID ?? "allow-always",
  rejectOnce: process.env.SPEG_ACP_REJECT_ONCE_OPTION_ID ?? "reject-once",
};
