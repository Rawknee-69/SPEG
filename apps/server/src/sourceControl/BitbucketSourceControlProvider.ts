...
import { SourceControlProviderError, type ChangeRequest } from "@speg/contracts";
...
export const makeDiscovery = Effect.gen(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set SPEG_BITBUCKET_EMAIL and SPEG_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
