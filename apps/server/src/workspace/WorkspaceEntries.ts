...
import { isExplicitRelativePath, isWindowsAbsolutePath } from "@speg/shared/path";
import { normalizeSearchQuery } from "@speg/shared/searchRanking";
...
>()("speg/workspace/WorkspaceEntries") {}
