import { ProjectId } from "@speg/contracts";
import { projectScriptRuntimeEnv, setupProjectScript } from "@speg/shared/projectScripts";
...
>()("speg/project/ProjectSetupScriptRunner") {}
