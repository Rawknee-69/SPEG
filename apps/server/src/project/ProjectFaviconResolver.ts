...
>()("speg/project/ProjectFaviconResolver") {}
...
export const make = Effect.gen(function* () {
  ...
  const projectFileLoader = yield* SpegProjectFileLoader.SpegProjectFileLoader;
  ...
  const resolvePath: ProjectFaviconResolver["Service"]["resolvePath"] = Effect.fn(
    ...
    // A speg.json iconPath takes precedence over the well-known locations.
