...
import { dedupeRemoteBranchesWithLocalMatches, normalizeGitRemoteUrl } from "@speg/shared/git";
import { compactTraceAttributes } from "@speg/shared/observability";
import { decodeJsonResult } from "@speg/shared/schemaJson";
...
> {
  ...
  const traceFilePath = yield* fs.makeTempFileScoped({
    prefix: `speg-git-trace2-${process.pid}-`,
    suffix: ".json",
  });
