    ...
    return Effect.gen(function* () {
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          ...
          clientInfo: { name: "speg-test", version: "0.0.0" },
          authMethodId: "test",
          requestLogger: (event) =>
            Effect.sync(() => {
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            args: mockAgentArgs,
            env: {
              SPEG_ACP_EMIT_INTERLEAVED_ASSISTANT_TOOL_CALLS: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "speg-test", version: "0.0.0" },
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          spawn: {
            ...
            args: mockAgentArgs,
            env: {
              SPEG_ACP_EMIT_GENERIC_TOOL_PLACEHOLDERS: "1",
            },
          },
          cwd: process.cwd(),
          clientInfo: { name: "speg-test", version: "0.0.0" },
  ...
  it.effect("completes session/load after replay becomes idle while its RPC stays pending", () =>
    Effect.gen(function* () {
      ...
      expect(started.sessionSetupResult._meta).toMatchObject({
        spegSessionLoadReady: "replay_idle",
      });
      ...
      Effect.provide(
        AcpSessionRuntime.layer({
          ...
          spawn: {
            ...
            args: mockAgentArgs,
            env: {
              SPEG_ACP_HANG_LOAD_SESSION_AFTER_REPLAY: "1",
              SPEG_ACP_LOAD_SESSION_DELAY_MS: "10000",
            },
          },
          cwd: process.cwd(),
          resumeSessionId: "mock-session-1",
