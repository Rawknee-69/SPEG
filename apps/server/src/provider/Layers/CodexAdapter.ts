...
import { getModelSelectionStringOptionValue } from "@speg/shared/model";
          ...
          ...(mcpSession
            ? {
                environment: {
                  ...
                  SPEG_MCP_BEARER_TOKEN: mcpSession.authorizationHeader.replace(/^Bearer\s+/, ""),
                },
                appServerArgs: [
                  "-c",
                  `mcp_servers.speg-code.url=${mcpSession.endpoint}`,
                  "-c",
                  'mcp_servers.speg-code.bearer_token_env_var="SPEG_MCP_BEARER_TOKEN"',
                ],
              }
            : {}),
        };
