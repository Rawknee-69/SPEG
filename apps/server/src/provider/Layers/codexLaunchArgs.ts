import { tokenizeCliArgs } from "@speg/shared/cliArgs";

export const SPEG_CODEX_LAUNCH_ARGS_ENV = "SPEG_CODEX_LAUNCH_ARGS";

export const resolveCodexLaunchArgs = (
  launchArgs?: string,
  environment: NodeJS.ProcessEnv = process.env,
) => environment[SPEG_CODEX_LAUNCH_ARGS_ENV]?.trim() || launchArgs?.trim() || "";
