import { readConnectAuthorizeRequest } from "@speg/shared/connectAuth";
...
const TEST_ENV = {
  SPEG_CLERK_PUBLISHABLE_KEY: "pk_test_Y2xlcmsuZXhhbXBsZS50ZXN0JA==",
  SPEG_CLERK_CLI_OAUTH_CLIENT_ID: "oauth_client_test",
  SPEG_HOSTED_APP_URL: "https://hosted.example.test",
};
