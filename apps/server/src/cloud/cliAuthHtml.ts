...
declare const __SPEG_BUILD_CHANNEL__: "nightly" | "latest" | undefined;

export function resolveLoopbackAuthorizationStage(): LoopbackAuthorizationStage {
  return typeof __SPEG_BUILD_CHANNEL__ === "undefined" ? "dev" : __SPEG_BUILD_CHANNEL__;
}

const stageBrands = {
  dev: "SPEG (Dev)",
  nightly: "SPEG (Nightly)",
  latest: "SPEG",
...
<html lang="en">
  <head>
    ...
    <title>SPEG Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up SPEG Connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
