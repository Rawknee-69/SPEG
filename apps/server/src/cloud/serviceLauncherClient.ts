...
import { HostProcessEnvironment } from "@speg/shared/hostProcess";
  ...
  override get message(): string {
    switch (this.operation) {
      ...
      case "version-mismatch":
        return "The service launcher started a different speg version.";
...
export const ServiceLauncherHostProcess = Context.Reference<ServiceLauncherProcess>(
  "speg/cloud/serviceLauncherHostProcess",
  {
    defaultValue: () => ({
...
>()("speg/cloud/serviceLauncherClient") {}
