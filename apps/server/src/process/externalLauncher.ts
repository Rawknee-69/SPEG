...
import { isCommandAvailable, resolveSpawnCommand } from "@speg/shared/shell";
...
// per-command cache lookups in @speg/shared/shell.
//
...
// command-resolution cache in @speg/shared/shell, so a backward wall-clock
