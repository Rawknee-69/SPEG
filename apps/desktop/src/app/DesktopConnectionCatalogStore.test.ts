...
import { ConnectionCatalogDocument } from "@speg/client-runtime/platform";
import { EnvironmentId, type PersistedSavedEnvironmentRecord } from "@speg/contracts";
...
const withStore = <A, E, R>(
  ...
  Effect.gen(function* () {
    ...
    const baseDir = yield* fileSystem.makeTempDirectoryScoped({
      prefix: "speg-desktop-connection-catalog-test-",
    });
