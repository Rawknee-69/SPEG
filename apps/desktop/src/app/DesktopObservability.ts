import { PRIMARY_LOCAL_ENVIRONMENT_ID } from "@speg/contracts";
import { makeLocalFileTracer, makeTraceSink } from "@speg/shared/observability";
...
>()("@speg/desktop/app/DesktopObservability/DesktopBackendOutputLogFactory") {}
