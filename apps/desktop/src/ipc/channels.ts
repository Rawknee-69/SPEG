...
export const PET_ENSURE_CHANNEL = "desktop:pet-ensure";
export const PET_HIDE_CHANNEL = "desktop:pet-hide";
export const PET_DRAG_CHANNEL = "desktop:pet-drag";
export const PET_SET_SETTINGS_CHANNEL = "desktop:pet-set-settings";
