import type { DesktopSshPasswordPromptRequest } from "@speg/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@speg/contracts";
import type { SshPasswordRequest } from "@speg/ssh/auth";
...
export class DesktopSshPromptWindowUnavailableError extends Schema.TaggedErrorClass<DesktopSshPromptWindowUnavailableError>()(
  ...
  override get message(): string {
    ...
    return `SPEG window is unavailable during ${this.stage} for SSH authentication to ${this.destination} (request: ${request}).`;
  }
}
...
>()("@speg/desktop/ssh/DesktopSshPasswordPrompts") {}
