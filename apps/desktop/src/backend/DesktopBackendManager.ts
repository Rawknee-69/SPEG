...
import { waitForHttpReady as waitForHttpReadyShared } from "@speg/shared/httpReadiness";
...
const BACKEND_READINESS_PATH = "/.well-known/speg/environment";
...
export interface DesktopBackendStartConfig extends BackendProcessContext {
  ...
  // SPEG_HOME can't pin the WSL backend to /mnt/c/...\.speg.
