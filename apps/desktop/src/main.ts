...
import { resolveRemoteSpegCliPackageSpec } from "@speg/ssh/command";
import type { RemoteSpegRunnerOptions } from "@speg/ssh/tunnel";
...
const resolveDesktopSshCliRunner = (
...
): RemoteSpegRunnerOptions => {
  const devRemoteEntryPath = Option.getOrUndefined(environment.devRemoteSpegServerEntryPath);
  ...
  return {
    packageSpec: resolveRemoteSpegCliPackageSpec({
