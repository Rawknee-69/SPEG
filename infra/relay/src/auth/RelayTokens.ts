...
import { encodeOAuthScope, parseAllowedOAuthScope } from "@speg/shared/oauthScope";
import {
...
const LINK_CHALLENGE_TYP = "speg-link-challenge+jwt";
const ACCESS_TOKEN_TYP = "speg-relay-dpop-access+jwt";
