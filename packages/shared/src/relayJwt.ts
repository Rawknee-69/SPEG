...
export const RELAY_LINK_PROOF_TYP = "speg-env-link+jwt";
export const RELAY_MINT_REQUEST_TYP = "speg-cloud-mint+jwt";
export const RELAY_HEALTH_REQUEST_TYP = "speg-cloud-health+jwt";
export const RELAY_MINT_RESPONSE_TYP = "speg-env-mint+jwt";
export const RELAY_HEALTH_RESPONSE_TYP = "speg-env-health+jwt";
export const RELAY_ACTIVITY_PUBLISH_TYP = "speg-env-activity+jwt";
