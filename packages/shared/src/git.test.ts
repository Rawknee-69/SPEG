import type { VcsStatusRemoteResult, VcsStatusResult } from "@speg/contracts";
...
describe("normalizeGitRemoteUrl", () => {
  it("canonicalizes equivalent GitHub remotes across protocol variants", () => {
    expect(normalizeGitRemoteUrl("git@github.com:Speg/Speg.git")).toBe(
      "github.com/speg/speg",
    );
    expect(normalizeGitRemoteUrl("https://github.com/Speg/Speg.git")).toBe(
      "github.com/speg/speg",
    );
    expect(normalizeGitRemoteUrl("ssh://git@github.com/Speg/Speg")).toBe(
      "github.com/speg/speg",
    );
  });

  it("preserves nested group paths for providers like GitLab", () => {
    expect(normalizeGitRemoteUrl("git@gitlab.com:Speg/platform/Speg.git")).toBe(
      "gitlab.com/speg/platform/speg",
    );
    expect(normalizeGitRemoteUrl("https://gitlab.com/Speg/platform/Speg.git")).toBe(
      "gitlab.com/speg/platform/speg",
    );
  });
...
describe("parseGitHubRepositoryNameWithOwnerFromRemoteUrl", () => {
  it("extracts the owner and repository from common GitHub remote shapes", () => {
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("git@github.com:Speg/Speg.git"),
    ).toBe("Speg/Speg");
    expect(
      parseGitHubRepositoryNameWithOwnerFromRemoteUrl("https://github.com/Speg/Speg.git"),
    ).toBe("Speg/Speg");
  });
});
