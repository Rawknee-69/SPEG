import { ORCHESTRATION_WS_METHODS, WS_METHODS } from "@speg/contracts";
...
}>("@speg/client-runtime/rpc/EnvironmentRpcRequestObserver", {
  defaultValue: () => ({
...
}>("@speg/client-runtime/rpc/EnvironmentRpcSubscriptionObserver", {
  defaultValue: () => ({
    observe: () => Effect.succeed(Effect.void),
  }),
}) {}
