import type { DesktopSshEnvironmentTarget, EnvironmentId } from "@speg/contracts";
import { resolveRemotePairingTarget } from "@speg/shared/remote";
...
>()("@speg/client-runtime/connection/onboarding/ConnectionOnboarding") {}
