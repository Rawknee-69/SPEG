...
>()("@speg/client-runtime/platform/persistence/ConnectionTargetStore") {}
...
>()("@speg/client-runtime/platform/persistence/ConnectionRegistrationStore") {}
...
>()("@speg/client-runtime/platform/persistence/EnvironmentCacheStore") {}
...
}>("@speg/client-runtime/platform/persistence/EnvironmentOwnedDataCleanup", {
  defaultValue: () => ({
    clear: () => Effect.void,
  }),
}) {}
