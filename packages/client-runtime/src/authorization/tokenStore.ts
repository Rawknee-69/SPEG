...
import { RelayManagedEndpoint } from "@speg/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@speg/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@speg/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
